<template>
  <div class="clearfix">
    ...
    <Modal :visible="previewVisible" title="图片预览" :footer="null" @cancel="handleCancel">
...
<script lang="ts">
  ...
  import { defineComponent, ref, onBeforeMount, watch, toRefs } from 'vue';
