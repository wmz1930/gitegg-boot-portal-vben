...
enum Api {
  Login = '/oauth/token',
  Logout = '/oauth/logout',
  GetUserInfo = '/system/account/user/info',
  UpdateUserInfo = '/system/account/info/update',
  UpdateUserAvatar = '/system/account/avatar/update',
  GetPermCode = '/system/resource/user/resource',
  TestRetry = '/testRetry',
}
