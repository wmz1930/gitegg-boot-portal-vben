...
export function updateGeneratorApiStatus(generatorApiId, status) {
  return defHttp.post({
    url: '/code/generator/api/status/' + generatorApiId + '/' + status,
  });
}

export function batchDeleteGeneratorApi(data) {
  return defHttp.post({
    url: '/code/generator/api/batch/delete',
    data,
  });
}
...
export function deleteGeneratorApi(id) {
  return defHttp.post({
    url: '/code/generator/api/delete/' + id,
  });
}

export function checkGeneratorApiExist(data) {
  return defHttp.post({
    url: '/code/generator/api/check',
    data,
  });
}
...
export function downloadGeneratorApiTemplate(query) {
  return defHttp.get({
    url: '/code/generator/api/download/template',
    responseType: 'blob',
    params: query,
  });
}
